...
public class ZdController {
    ...
    @ResponseBody
    @Log(module = "数据字典", desc = "获取数据字典列表", optType = Constants.OptType.SELECT)
    ...
    @ResponseBody
    @Log(module = "数据字典", desc = "获取字典详情", optType = Constants.OptType.SELECT)
    ...
    @ResponseBody
    @Log(module = "数据字典", desc = "添加/编辑字典", optType = Constants.OptType.AE)
